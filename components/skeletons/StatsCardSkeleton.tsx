...
export function QuickActionSkeleton({ isPrimary = false }: { isPrimary?: boolean }) {
  return (
    ...
    >
      <div className="size-12 rounded-lg bg-bg-secondary mb-4" />
      <div className="h-5 bg-bg-secondary rounded w-24 mb-2" />
...
export function ActivityItemSkeleton() {
  return (
    <div className="flex items-center gap-4 bg-bg-card border border-border p-4 rounded-xl animate-pulse">
  ...
  return (
    <div className="space-y-6">
      ...
      <section className="flex flex-col gap-1 animate-pulse">
        <div className="h-12 bg-bg-secondary rounded w-64 mb-1" />
        <div className="h-12 bg-bg-secondary rounded w-56 mb-1" />
        <div className="h-12 bg-bg-secondary rounded w-48" />
        <div className="h-4 bg-bg-secondary rounded w-48 mt-2" />
      </section>
