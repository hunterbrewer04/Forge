...
export default function NewSessionPage() {
  ...
  if (authLoading) {
    return (
      <GlassAppLayout title="Create Session" showBack showNotifications={false} desktopTitle="Create Session">
    ...
    return (
      <GlassAppLayout title="Create Session" showBack showNotifications={false} desktopTitle="Create Session">
        <div className="flex flex-col items-center justify-center py-12">
          ...
          <p className="text-text-secondary">Redirecting to schedule...</p>
        </div>
      </GlassAppLayout>
    )
  }
    ...
    <GlassAppLayout title="Create Session" showBack showNotifications={false} desktopTitle="Create Session">
      <GlassCard variant="subtle" className="p-8 lg:max-w-2xl lg:mx-auto">
        <form onSubmit={handleSubmit} className="space-y-6 pb-32">
          ...
          {/* Session Type */}
          <div>
            <label htmlFor="session_type_id" className="block text-sm font-medium text-text-secondary mb-2">
              Session Type
            </label>
            <select
              id="session_type_id"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label htmlFor="starts_at" className="block text-sm font-medium text-text-secondary mb-2">
                Date *
              </label>
              <input
                type="date"
            ...
            <div>
              <label htmlFor="starts_time" className="block text-sm font-medium text-text-secondary mb-2">
                Time *
              </label>
              <input
                type="time"
