          ...
          <form onSubmit={handleSave} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full bg-bg-input text-text-primary px-4 py-3 rounded-xl border border-transparent focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary transition-all"
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full bg-bg-input text-text-primary pl-8 pr-4 py-3 rounded-xl border transition-all focus:outline-none focus:ring-1 ${
                    usernameError
              ...
              <p className="text-text-muted text-xs">3-20 characters. Letters, numbers, and underscores only.</p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 bg-bg-input text-text-primary px-4 py-3 rounded-xl border border-transparent focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary transition-all"
              ...
              {emailChanged && !emailMessage && (
                <p className="text-text-muted text-xs">Click the mail icon to send a verification email to your new address.</p>
              )}
            </div>
            ...
            <div className="flex gap-3 pt-4">
              <button
                ...
                disabled={saving}
                className="flex-1 flex items-center justify-center gap-2 bg-bg-input text-text-primary py-3.5 rounded-xl font-bold transition-all active:scale-95 disabled:opacity-50"
              >
